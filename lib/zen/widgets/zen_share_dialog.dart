...
/// Displays a Zen share dialog with a score of the completed puzzle
/// and an option to share the score using Twitter or Facebook.
/// {@endtemplate}
class ZenShareDialog extends StatefulWidget {
  /// {@macro zen_share_dialog}
  const ZenShareDialog({
    Key? key,
  ...
  @override
  State<ZenShareDialog> createState() => _ZenShareDialogState();
}

class _ZenShareDialogState extends State<ZenShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('zen_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('zen_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('zen_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: ZenShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('zen_share_dialog_close_button'),
