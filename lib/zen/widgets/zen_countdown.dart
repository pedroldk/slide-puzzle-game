...
/// {@endtemplate}
class ZenCountdown extends StatefulWidget {
  /// {@macro zen_countdown}
  const ZenCountdown({
    Key? key,
  ...
  @override
  State<ZenCountdown> createState() => _ZenCountdownState();
}

class _ZenCountdownState extends State<ZenCountdown> {
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      ...
      child: BlocListener<ZenPuzzleBloc, ZenPuzzleState>(
        listener: (context, state) {
          ...
          if (state.status == ZenPuzzleStatus.started) {
...
/// {@template zen_countdown_seconds_to_begin}
/// Display how many seconds are left to begin the puzzle.
/// {@endtemplate}
@visibleForTesting
class ZenCountdownSecondsToBegin extends StatefulWidget {
  /// {@macro zen_countdown_seconds_to_begin}
  const ZenCountdownSecondsToBegin({
    Key? key,
  ...
  @override
  State<ZenCountdownSecondsToBegin> createState() =>
...
/// {@template zen_countdown_go}
/// Displays a "Go!" text when the countdown reaches 0 seconds.
/// {@endtemplate}
@visibleForTesting
class ZenCountdownGo extends StatefulWidget {
  /// {@macro zen_countdown_go}
  const ZenCountdownGo({Key? key}) : super(key: key);

  @override
  State<ZenCountdownGo> createState() => _ZenCountdownGoState();
}

class _ZenCountdownGoState extends State<ZenCountdownGo>
