...
/// {@template zen_puzzle_tile}
/// Displays the puzzle tile associated with [tile]
/// based on the puzzle [state].
/// {@endtemplate}
class ZenPuzzleTile extends StatefulWidget {
  /// {@macro zen_puzzle_tile}
  const ZenPuzzleTile({
    Key? key,
    required this.tile,
    required this.state,
  ...
  @override
  State<ZenPuzzleTile> createState() => ZenPuzzleTileState();
}

/// The state of [ZenPuzzleTile].
@visibleForTesting
class ZenPuzzleTileState extends State<ZenPuzzleTile>
  ...
  Widget build(BuildContext context) {
    ...
    final movementDuration = status == ZenPuzzleStatus.loading
      ...
      child: AnimatedAlign(
        ...
        child: ResponsiveLayoutBuilder(
          small: (_, child) => SizedBox.square(
            key: Key('zen_puzzle_tile_small_${widget.tile.value}'),
            dimension: _TileSize.small,
            child: child,
          ),
          medium: (_, child) => SizedBox.square(
            key: Key('zen_puzzle_tile_medium_${widget.tile.value}'),
            dimension: _TileSize.medium,
            child: child,
          ),
          large: (_, child) => SizedBox.square(
            key: Key('zen_puzzle_tile_large_${widget.tile.value}'),
          ...
          child: (_) => MouseRegion(
            ...
            child: ScaleTransition(
              key: Key('zen_puzzle_tile_scale_${widget.tile.value}'),
              scale: _scale,
              child: IconButton(
