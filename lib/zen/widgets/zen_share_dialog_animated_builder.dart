...
/// The animation builder of [ZenShareDialog].
class ZenShareDialogAnimatedBuilder extends StatelessWidget {
  const ZenShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          ZenShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  ZenShareDialogEnterAnimation animation,
);

class ZenShareDialogEnterAnimation {
  ZenShareDialogEnterAnimation(this.controller)
