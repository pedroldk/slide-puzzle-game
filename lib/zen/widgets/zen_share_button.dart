...
/// {@template zen_twitter_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Twitter when tapped.
/// {@endtemplate}
class ZenTwitterButton extends StatelessWidget {
  /// {@macro zen_twitter_button}
  const ZenTwitterButton({Key? key}) : super(key: key);
...
/// {@template zen_facebook_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Facebook when tapped.
/// {@endtemplate}
class ZenFacebookButton extends StatelessWidget {
  /// {@macro zen_facebook_button}
  const ZenFacebookButton({Key? key}) : super(key: key);
...
/// {@template zen_share_button}
/// Displays a share button colored with [color] which
/// displays the [icon] and [title] as its content.
/// {@endtemplate}
@visibleForTesting
class ZenShareButton extends StatefulWidget {
  /// {@macro zen_share_button}
  const ZenShareButton({
    Key? key,
  ...
  @override
  State<ZenShareButton> createState() => _ZenShareButtonState();
}

class _ZenShareButtonState extends State<ZenShareButton> {
