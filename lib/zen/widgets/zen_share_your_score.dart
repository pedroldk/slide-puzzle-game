...
import 'package:very_good_slide_puzzle/zen/widgets/zen_share_button.dart';
...
/// {@template zen_share_your_score}
/// Displays buttons to share a score of the completed puzzle.
/// {@endtemplate}
class ZenShareYourScore extends StatelessWidget {
  /// {@macro zen_share_your_score}
  const ZenShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final ZenShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('zen_share_your_score'),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      key: const Key('zen_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        key: const Key('zen_share_your_score_message'),
                        textAlign: textAlign,
