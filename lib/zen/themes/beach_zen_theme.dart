...
/// {@endtemplate}
class BeachZenTheme extends ZenTheme {
  /// {@macro galaxy_zen_theme}
  const BeachZenTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/zen/gallery/beach.png';

  @override
  String get successThemeAsset => 'assets/images/zen/gallery/beach.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/zen/beach';
}
