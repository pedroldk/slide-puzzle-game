...
/// {@endtemplate}
class FrogsZenTheme extends ZenTheme {
  /// {@macro galaxy_zen_theme}
  const FrogsZenTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/zen/gallery/frogs.png';

  @override
  String get successThemeAsset => 'assets/images/zen/gallery/frogs.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/zen/frogs';
}
