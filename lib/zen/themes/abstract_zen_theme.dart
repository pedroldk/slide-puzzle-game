...
/// {@endtemplate}
class AbstractZenTheme extends ZenTheme {
  /// {@macro galaxy_zen_theme}
  const AbstractZenTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/zen/gallery/abstract.png';

  @override
  String get successThemeAsset => 'assets/images/zen/gallery/abstract.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/zen/abstract';
}
