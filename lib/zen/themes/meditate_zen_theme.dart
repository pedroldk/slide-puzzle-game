...
/// {@endtemplate}
class MeditateZenTheme extends ZenTheme {
  /// {@macro galaxy_zen_theme}
  const MeditateZenTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/zen/gallery/meditate.png';

  @override
  String get successThemeAsset => 'assets/images/zen/gallery/meditate.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/zen/meditate';
}
