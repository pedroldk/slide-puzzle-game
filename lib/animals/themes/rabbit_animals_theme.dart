...
/// {@endtemplate}
class RabbitAnimalsTheme extends AnimalsTheme {
  /// {@macro galaxy_space_theme}
  const RabbitAnimalsTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/animals/gallery/rabbit.png';

  @override
  String get successThemeAsset => 'assets/images/animals/gallery/rabbit.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/animals/rabbit';
}
