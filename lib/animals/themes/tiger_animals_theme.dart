...
/// {@endtemplate}
class TigerAnimalsTheme extends AnimalsTheme {
  /// {@macro galaxy_space_theme}
  const TigerAnimalsTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/animals/gallery/tiger.png';

  @override
  String get successThemeAsset => 'assets/images/animals/gallery/tiger.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/animals/tiger';
}
