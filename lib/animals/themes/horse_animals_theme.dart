...
/// {@endtemplate}
class HorseAnimalsTheme extends AnimalsTheme {
  /// {@macro galaxy_space_theme}
  const HorseAnimalsTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/animals/gallery/horse.png';

  @override
  String get successThemeAsset => 'assets/images/animals/gallery/horse.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/animals/horse';
}
