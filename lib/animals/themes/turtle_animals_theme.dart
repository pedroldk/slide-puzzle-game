...
/// {@endtemplate}
class TurtleAnimalsTheme extends AnimalsTheme {
  /// {@macro galaxy_space_theme}
  const TurtleAnimalsTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/animals/gallery/turtle.png';

  @override
  String get successThemeAsset => 'assets/images/animals/gallery/turtle.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/animals/turtle';
}
