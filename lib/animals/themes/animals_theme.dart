...
/// {@template animals_theme}
/// The animals puzzle theme.
/// {@endtemplate}
abstract class AnimalsTheme extends PuzzleTheme {
  /// {@macro animals_theme}
  const AnimalsTheme() : super();
  ...
  PuzzleLayoutDelegate get layoutDelegate =>
      const AnimalsPuzzleLayoutDelegate();
  ...
  ///
  /// This asset is shown in the Animals theme picker.
  String get themeAsset;

  /// The path to the success image asset of this theme.
  ///
  /// This asset is shown in the success state of the Animals puzzle.
