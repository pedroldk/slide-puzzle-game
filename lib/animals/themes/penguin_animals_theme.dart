...
/// {@endtemplate}
class PenguinAnimalsTheme extends AnimalsTheme {
  /// {@macro galaxy_space_theme}
  const PenguinAnimalsTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/animals/gallery/penguin.png';

  @override
  String get successThemeAsset => 'assets/images/animals/gallery/penguin.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/animals/penguin';
}
