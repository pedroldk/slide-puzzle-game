...
/// {@endtemplate}
class CatAnimalsTheme extends AnimalsTheme {
  /// {@macro galaxy_space_theme}
  const CatAnimalsTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/animals/gallery/cat.png';

  @override
  String get successThemeAsset => 'assets/images/animals/gallery/cat.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/animals/cat';
}
