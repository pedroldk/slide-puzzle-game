...
/// The animation builder of [AnimalsShareDialog].
class AnimalsShareDialogAnimatedBuilder extends StatelessWidget {
  const AnimalsShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          AnimalsShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  AnimalsShareDialogEnterAnimation animation,
);

class AnimalsShareDialogEnterAnimation {
  AnimalsShareDialogEnterAnimation(this.controller)
