...
/// {@template animals_share_your_score}
/// Displays buttons to share a score of the completed puzzle.
/// {@endtemplate}
class AnimalsShareYourScore extends StatelessWidget {
  /// {@macro animals_share_your_score}
  const AnimalsShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final AnimalsShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('animals_share_your_score'),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      key: const Key('animals_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        key: const Key('animals_share_your_score_message'),
                        textAlign: textAlign,
            ...
            SlideTransition(
              ...
              child: Opacity(
                ...
                child: Row(
                  ...
                  children: const [
                    AnimalsTwitterButton(),
                    Gap(16),
                    AnimalsFacebookButton(),
                  ],
                ),
              ),
            ),
