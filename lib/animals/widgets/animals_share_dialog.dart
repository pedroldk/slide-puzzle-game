...
/// {@endtemplate}
class AnimalsShareDialog extends StatefulWidget {
  /// {@macro animals_share_dialog}
  const AnimalsShareDialog({
    Key? key,
  ...
  @override
  State<AnimalsShareDialog> createState() => _AnimalsShareDialogState();
}

class _AnimalsShareDialogState extends State<AnimalsShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('animals_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('animals_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('animals_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: AnimalsShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('animals_share_dialog_close_button'),
