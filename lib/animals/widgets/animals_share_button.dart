...
/// {@template animals_twitter_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Twitter when tapped.
/// {@endtemplate}
class AnimalsTwitterButton extends StatelessWidget {
  /// {@macro animals_twitter_button}
  const AnimalsTwitterButton({Key? key}) : super(key: key);
...
/// {@template animals_facebook_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Facebook when tapped.
/// {@endtemplate}
class AnimalsFacebookButton extends StatelessWidget {
  /// {@macro animals_facebook_button}
  const AnimalsFacebookButton({Key? key}) : super(key: key);
...
/// {@template animals_share_button}
/// Displays a share button colored with [color] which
/// displays the [icon] and [title] as its content.
/// {@endtemplate}
@visibleForTesting
class AnimalsShareButton extends StatefulWidget {
  /// {@macro animals_share_button}
  const AnimalsShareButton({
    Key? key,
  ...
  @override
  State<AnimalsShareButton> createState() => _AnimalsShareButtonState();
}

class _AnimalsShareButtonState extends State<AnimalsShareButton> {
