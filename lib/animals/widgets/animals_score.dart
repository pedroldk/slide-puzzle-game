...
import 'package:very_good_slide_puzzle/animals/widgets/animals_timer.dart';
...
/// {@template animals_score}
/// Displays the score of the solved Animals puzzle.
/// {@endtemplate}
class AnimalsScore extends StatelessWidget {
  /// {@macro animals_score}
  const AnimalsScore({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        key: const Key('animals_score_completed'),
                        ...
                        child: AnimatedDefaultTextStyle(
                          ...
                          child: Text(l10n.spaceSuccessCompleted),
                        ),
                      ),
                      const ResponsiveGap(
                        small: 8,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('animals_score_well_done'),
                        style: wellDoneTextStyle.copyWith(
                          color: PuzzleColors.white,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                        child: Text(l10n.spaceSuccessWellDone),
                      ),
                      const ResponsiveGap(
                        small: 24,
                        medium: 32,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('animals_score_score'),
                        style: PuzzleTextStyle.headline5.copyWith(
                          color: theme.defaultColor,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                        child: Text(l10n.spaceSuccessScore),
                      ),
                      const ResponsiveGap(
                        small: 8,
                        medium: 9,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('animals_score_number_of_moves'),
                        style: numberOfMovesTextStyle.copyWith(
                          color: PuzzleColors.white,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                        child: Text(
                          l10n.spaceSuccessNumberOfMoves(
