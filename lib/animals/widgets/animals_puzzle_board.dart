...
/// {@template animals_puzzle_board}
/// Displays the board of the puzzle in a [Stack] filled with [tiles].
/// {@endtemplate}
class AnimalsPuzzleBoard extends StatefulWidget {
  /// {@macro animals_puzzle_board}
  const AnimalsPuzzleBoard({
    Key? key,
    required this.tiles,
  }) : super(key: key);
  ...
  @override
  State<AnimalsPuzzleBoard> createState() => _AnimalsPuzzleBoardState();
}

class _AnimalsPuzzleBoardState extends State<AnimalsPuzzleBoard> {
    ...
    return BlocListener<PuzzleBloc, PuzzleState>(
          ...
          _completePuzzleTimer =
            ...
            await showAppDialog<void>(
              ...
              child: MultiBlocProvider(
                providers: [
                  BlocProvider.value(
                    value: context.read<AnimalsThemeBloc>(),
                  ),
                  BlocProvider.value(
                ...
                child: const AnimalsShareDialog(),
              ),
            );
          });
        }
      ...
      child: ResponsiveLayoutBuilder(
        small: (_, child) => SizedBox.square(
          key: const Key('animals_puzzle_board_small'),
          dimension: _BoardSize.small,
          child: child,
        ),
        medium: (_, child) => SizedBox.square(
          key: const Key('animals_puzzle_board_medium'),
          dimension: _BoardSize.medium,
          child: child,
        ),
        large: (_, child) => SizedBox.square(
          key: const Key('animals_puzzle_board_large'),
