...
/// {@template animals_puzzle_tile}
/// Displays the puzzle tile associated with [tile]
/// based on the puzzle [state].
/// {@endtemplate}
class AnimalsPuzzleTile extends StatefulWidget {
  /// {@macro animals_puzzle_tile}
  const AnimalsPuzzleTile({
    Key? key,
    required this.tile,
    required this.state,
  ...
  @override
  State<AnimalsPuzzleTile> createState() => AnimalsPuzzleTileState();
}

/// The state of [AnimalsPuzzleTile].
@visibleForTesting
class AnimalsPuzzleTileState extends State<AnimalsPuzzleTile>
  ...
  Widget build(BuildContext context) {
    ...
    final movementDuration = status == AnimalsPuzzleStatus.loading
      ...
      child: AnimatedAlign(
        ...
        child: ResponsiveLayoutBuilder(
          small: (_, child) => SizedBox.square(
            key: Key('animals_puzzle_tile_small_${widget.tile.value}'),
            dimension: _TileSize.small,
            child: child,
          ),
          medium: (_, child) => SizedBox.square(
            key: Key('animals_puzzle_tile_medium_${widget.tile.value}'),
            dimension: _TileSize.medium,
            child: child,
          ),
          large: (_, child) => SizedBox.square(
            key: Key('animals_puzzle_tile_large_${widget.tile.value}'),
          ...
          child: (_) => MouseRegion(
            ...
            child: ScaleTransition(
              key: Key('animals_puzzle_tile_scale_${widget.tile.value}'),
              scale: _scale,
              child: IconButton(
