...
/// {@endtemplate}
class WaterCastlesTheme extends CastlesTheme {
  /// {@macro galaxy_castles_theme}
  const WaterCastlesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/castles/gallery/water.png';

  @override
  String get successThemeAsset => 'assets/images/castles/gallery/water.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/castles/water';
}
