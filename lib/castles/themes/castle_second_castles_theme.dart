...
/// {@endtemplate}
class CastleSecondCastlesTheme extends CastlesTheme {
  /// {@macro galaxy_castles_theme}
  const CastleSecondCastlesTheme() : super();
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/castles/castle_second';
}
