...
/// The castles puzzle theme.
/// {@endtemplate}
abstract class CastlesTheme extends PuzzleTheme {
  /// {@macro castles_theme}
  const CastlesTheme() : super();
  ...
  ///
  /// This asset is shown in the Castles theme picker.
  String get themeAsset;

  /// The path to the success image asset of this theme.
  ///
  /// This asset is shown in the success state of the Castles puzzle.
