...
/// {@endtemplate}
class FairytaleCastlesTheme extends CastlesTheme {
  /// {@macro galaxy_castles_theme}
  const FairytaleCastlesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/castles/gallery/fairytale.png';

  @override
  String get successThemeAsset => 'assets/images/castles/gallery/fairytale.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/castles/fairytale';
}
