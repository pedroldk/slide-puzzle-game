...
/// {@endtemplate}
class NeuschwansteinCastlesTheme extends CastlesTheme {
  /// {@macro galaxy_castles_theme}
  const NeuschwansteinCastlesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/castles/gallery/neuschwanstein.png';

  @override
  String get successThemeAsset => 'assets/images/castles/gallery/neuschwanstein.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/castles/neuschwanstein';
}
