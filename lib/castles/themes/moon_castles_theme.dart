...
/// {@endtemplate}
class MoonCastlesTheme extends CastlesTheme {
  /// {@macro galaxy_castles_theme}
  const MoonCastlesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/castles/gallery/moon.png';

  @override
  String get successThemeAsset => 'assets/images/castles/gallery/moon.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/castles/moon';
}
