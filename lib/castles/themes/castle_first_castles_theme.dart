...
/// {@endtemplate}
class CastleFirstCastlesTheme extends CastlesTheme {
  /// {@macro galaxy_castles_theme}
  const CastleFirstCastlesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/castles/gallery/castle_first.png';

  @override
  String get successThemeAsset => 'assets/images/castles/gallery/castle_first.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/castles/castle_first';
}
