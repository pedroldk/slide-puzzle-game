...
/// {@endtemplate}
class ArchitectureCastlesTheme extends CastlesTheme {
  /// {@macro galaxy_castles_theme}
  const ArchitectureCastlesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/castles/gallery/architecture.png';

  @override
  String get successThemeAsset => 'assets/images/castles/gallery/architecture.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/castles/architecture';
}
