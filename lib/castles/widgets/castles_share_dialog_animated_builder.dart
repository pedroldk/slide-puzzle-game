...
/// The animation builder of [CastlesShareDialog].
class CastlesShareDialogAnimatedBuilder extends StatelessWidget {
  const CastlesShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          CastlesShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  CastlesShareDialogEnterAnimation animation,
);

class CastlesShareDialogEnterAnimation {
  CastlesShareDialogEnterAnimation(this.controller)
