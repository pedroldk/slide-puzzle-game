...
/// {@template castles_puzzle_tile}
/// Displays the puzzle tile associated with [tile]
/// based on the puzzle [state].
/// {@endtemplate}
class CastlesPuzzleTile extends StatefulWidget {
  /// {@macro castles_puzzle_tile}
  const CastlesPuzzleTile({
    Key? key,
    required this.tile,
    required this.state,
  ...
  @override
  State<CastlesPuzzleTile> createState() => CastlesPuzzleTileState();
}

/// The state of [CastlesPuzzleTile].
@visibleForTesting
class CastlesPuzzleTileState extends State<CastlesPuzzleTile>
  ...
  Widget build(BuildContext context) {
    ...
    final movementDuration = status == CastlesPuzzleStatus.loading
      ...
      child: AnimatedAlign(
        ...
        child: ResponsiveLayoutBuilder(
          small: (_, child) => SizedBox.square(
            key: Key('castles_puzzle_tile_small_${widget.tile.value}'),
            dimension: _TileSize.small,
            child: child,
          ),
          medium: (_, child) => SizedBox.square(
            key: Key('castles_puzzle_tile_medium_${widget.tile.value}'),
            dimension: _TileSize.medium,
            child: child,
          ),
          large: (_, child) => SizedBox.square(
            key: Key('castles_puzzle_tile_large_${widget.tile.value}'),
          ...
          child: (_) => MouseRegion(
            ...
            child: ScaleTransition(
              key: Key('castles_puzzle_tile_scale_${widget.tile.value}'),
              scale: _scale,
              child: IconButton(
