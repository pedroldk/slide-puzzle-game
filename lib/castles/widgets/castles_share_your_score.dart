...
import 'package:very_good_slide_puzzle/castles/widgets/castles_share_button.dart';
import 'package:very_good_slide_puzzle/castles/widgets/castles_share_dialog_animated_builder.dart';
import 'package:very_good_slide_puzzle/typography/typography.dart';

/// {@template castles_share_your_score}
/// Displays buttons to share a score of the completed puzzle.
/// {@endtemplate}
class CastlesShareYourScore extends StatelessWidget {
  /// {@macro castles_share_your_score}
  const CastlesShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final CastlesShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('castles_share_your_score'),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      key: const Key('castles_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        key: const Key('castles_share_your_score_message'),
                        textAlign: textAlign,
            ...
            SlideTransition(
              ...
              child: Opacity(
                ...
                child: Row(
                  ...
                  children: const [
                    CastlesTwitterButton(),
                    Gap(16),
                    CastlesFacebookButton(),
                  ],
                ),
              ),
            ),
