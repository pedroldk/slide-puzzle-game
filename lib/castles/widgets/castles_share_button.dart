...
/// {@template castles_twitter_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Twitter when tapped.
/// {@endtemplate}
class CastlesTwitterButton extends StatelessWidget {
  /// {@macro castles_twitter_button}
  const CastlesTwitterButton({Key? key}) : super(key: key);
...
/// {@template castles_facebook_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Facebook when tapped.
/// {@endtemplate}
class CastlesFacebookButton extends StatelessWidget {
  /// {@macro castles_facebook_button}
  const CastlesFacebookButton({Key? key}) : super(key: key);
...
/// {@template castles_share_button}
/// Displays a share button colored with [color] which
/// displays the [icon] and [title] as its content.
/// {@endtemplate}
@visibleForTesting
class CastlesShareButton extends StatefulWidget {
  /// {@macro castles_share_button}
  const CastlesShareButton({
    Key? key,
  ...
  @override
  State<CastlesShareButton> createState() => _CastlesShareButtonState();
}

class _CastlesShareButtonState extends State<CastlesShareButton> {
