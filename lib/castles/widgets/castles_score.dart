...
/// {@template castles_score}
/// Displays the score of the solved Castles puzzle.
/// {@endtemplate}
class CastlesScore extends StatelessWidget {
  /// {@macro castles_score}
  const CastlesScore({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        key: const Key('castles_score_completed'),
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('castles_score_well_done'),
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('castles_score_score'),
                        style: PuzzleTextStyle.headline5.copyWith(
                          color: theme.defaultColor,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('castles_score_number_of_moves'),
