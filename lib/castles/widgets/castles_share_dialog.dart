...
/// {@endtemplate}
class CastlesShareDialog extends StatefulWidget {
  /// {@macro castles_share_dialog}
  const CastlesShareDialog({
    Key? key,
  ...
  @override
  State<CastlesShareDialog> createState() => _CastlesShareDialogState();
}

class _CastlesShareDialogState extends State<CastlesShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('castles_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('castles_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('castles_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: CastlesShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('castles_share_dialog_close_button'),
