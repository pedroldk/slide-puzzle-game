...
/// {@endtemplate}
class DinosaursShareDialog extends StatefulWidget {
  /// {@macro dinosaurs_share_dialog}
  const DinosaursShareDialog({
    Key? key,
  ...
  @override
  State<DinosaursShareDialog> createState() => _DinosaursShareDialogState();
}

class _DinosaursShareDialogState extends State<DinosaursShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('dinosaurs_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('dinosaurs_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('dinosaurs_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: DinosaursShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('dinosaurs_share_dialog_close_button'),
