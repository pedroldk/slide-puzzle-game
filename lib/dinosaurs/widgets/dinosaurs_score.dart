...
/// {@template dinosaurs_score}
/// Displays the score of the solved Dinosaurs puzzle.
/// {@endtemplate}
class DinosaursScore extends StatelessWidget {
  /// {@macro dinosaurs_score}
  const DinosaursScore({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        key: const Key('dinosaurs_score_completed'),
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('dinosaurs_score_well_done'),
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('dinosaurs_score_score'),
                        style: PuzzleTextStyle.headline5.copyWith(
                          color: theme.defaultColor,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('dinosaurs_score_number_of_moves'),
