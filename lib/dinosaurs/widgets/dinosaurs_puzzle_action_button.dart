...
/// {@template dinosaurs_puzzle_action_button}
/// Displays the action button to start or shuffle the puzzle
/// based on the current puzzle state.
/// {@endtemplate}
class DinosaursPuzzleActionButton extends StatefulWidget {
  /// {@macro dinosaurs_puzzle_action_button}
  const DinosaursPuzzleActionButton({Key? key, AudioPlayerFactory? audioPlayer})
  ...
  @override
  State<DinosaursPuzzleActionButton> createState() =>
      _DinosaursPuzzleActionButtonState();
}

class _DinosaursPuzzleActionButtonState
    extends State<DinosaursPuzzleActionButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading = status == DinosaursPuzzleStatus.loading;
    final isStarted = status == DinosaursPuzzleStatus.started;
          ...
          child: PuzzleButton(
            onPressed: isLoading
                ...
                : () async {
                    ...
                    context.read<DinosaursPuzzleBloc>().add(
                          DinosaursCountdownReset(
