...
/// The animation builder of [DinosaursShareDialog].
class DinosaursShareDialogAnimatedBuilder extends StatelessWidget {
  const DinosaursShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          DinosaursShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  DinosaursShareDialogEnterAnimation animation,
);

class DinosaursShareDialogEnterAnimation {
  DinosaursShareDialogEnterAnimation(this.controller)
