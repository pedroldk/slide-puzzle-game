...
/// {@template dinosaurs_twitter_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Twitter when tapped.
/// {@endtemplate}
class DinosaursTwitterButton extends StatelessWidget {
  /// {@macro dinosaurs_twitter_button}
  const DinosaursTwitterButton({Key? key}) : super(key: key);
...
/// {@template dinosaurs_facebook_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Facebook when tapped.
/// {@endtemplate}
class DinosaursFacebookButton extends StatelessWidget {
  /// {@macro dinosaurs_facebook_button}
  const DinosaursFacebookButton({Key? key}) : super(key: key);
...
/// {@template dinosaurs_share_button}
/// Displays a share button colored with [color] which
/// displays the [icon] and [title] as its content.
/// {@endtemplate}
@visibleForTesting
class DinosaursShareButton extends StatefulWidget {
  /// {@macro dinosaurs_share_button}
  const DinosaursShareButton({
    Key? key,
  ...
  @override
  State<DinosaursShareButton> createState() => _DinosaursShareButtonState();
}

class _DinosaursShareButtonState extends State<DinosaursShareButton> {
