...
/// {@endtemplate}
class DinosaursShareYourScore extends StatelessWidget {
  /// {@macro dinosaurs_share_your_score}
  const DinosaursShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final DinosaursShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('dinosaurs_share_your_score'),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      key: const Key('dinosaurs_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        key: const Key('dinosaurs_share_your_score_message'),
                        textAlign: textAlign,
            ...
            SlideTransition(
              ...
              child: Opacity(
                ...
                child: Row(
                  ...
                  children: const [
                    DinosaursTwitterButton(),
                    Gap(16),
                    DinosaursFacebookButton(),
                  ],
                ),
              ),
            ),
