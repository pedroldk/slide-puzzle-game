...
/// {@template dinosaurs_timer}
/// Displays how many seconds elapsed since starting the puzzle.
/// {@endtemplate}
class DinosaursTimer extends StatelessWidget {
  /// {@macro dinosaurs_timer}
  const DinosaursTimer({
    Key? key,
    this.textStyle,
    this.iconSize,
    this.iconPadding,
        ...
        return Row(
          ...
          children: [
            ...
            Image.asset(
              ...
              key: const Key('dinosaurs_timer_icon'),
  ...
  String _getDurationLabel(Duration duration, BuildContext context) {
    return context.l10n.spacePuzzleDurationLabelText(
