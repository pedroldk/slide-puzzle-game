...
/// {@endtemplate}
class SpaceShareYourScore extends StatelessWidget {
  /// {@macro space_share_your_score}
  const SpaceShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final SpaceShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('space_share_your_score'),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      key: const Key('space_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        ...
                        key: const Key('space_share_your_score_message'),
                        textAlign: textAlign,
