...
/// {@template space_twitter_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Twitter when tapped.
/// {@endtemplate}
class SpaceTwitterButton extends StatelessWidget {
  /// {@macro space_twitter_button}
  const SpaceTwitterButton({Key? key}) : super(key: key);
...
/// {@template space_facebook_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Facebook when tapped.
/// {@endtemplate}
class SpaceFacebookButton extends StatelessWidget {
  /// {@macro space_facebook_button}
  const SpaceFacebookButton({Key? key}) : super(key: key);
...
/// {@template space_share_button}
/// Displays a share button colored with [color] which
/// displays the [icon] and [title] as its content.
/// {@endtemplate}
@visibleForTesting
class SpaceShareButton extends StatefulWidget {
  /// {@macro space_share_button}
  const SpaceShareButton({
    Key? key,
  ...
  @override
  State<SpaceShareButton> createState() => _SpaceShareButtonState();
}

class _SpaceShareButtonState extends State<SpaceShareButton> {
