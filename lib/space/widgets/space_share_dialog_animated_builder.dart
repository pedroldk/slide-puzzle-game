...
/// The animation builder of [SpaceShareDialog].
class SpaceShareDialogAnimatedBuilder extends StatelessWidget {
  const SpaceShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          SpaceShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  SpaceShareDialogEnterAnimation animation,
);

class SpaceShareDialogEnterAnimation {
  SpaceShareDialogEnterAnimation(this.controller)
