...
/// {@endtemplate}
class SpaceShareDialog extends StatefulWidget {
  /// {@macro space_share_dialog}
  const SpaceShareDialog({
    Key? key,
  ...
  @override
  State<SpaceShareDialog> createState() => _SpaceShareDialogState();
}

class _SpaceShareDialogState extends State<SpaceShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('space_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('space_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('space_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: SpaceShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('space_share_dialog_close_button'),
