...
/// {@template space_score}
/// Displays the score of the solved Space puzzle.
/// {@endtemplate}
class SpaceScore extends StatelessWidget {
  /// {@macro space_score}
  const SpaceScore({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        key: const Key('space_score_completed'),
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('space_score_well_done'),
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('space_score_score'),
                        style: PuzzleTextStyle.headline5.copyWith(
                          color: theme.defaultColor,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('space_score_number_of_moves'),
