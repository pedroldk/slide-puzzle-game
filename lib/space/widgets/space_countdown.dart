...
/// {@template space_countdown}
/// Displays the countdown before the puzzle is started.
/// {@endtemplate}
class SpaceCountdown extends StatefulWidget {
  /// {@macro space_countdown}
  ...
  @override
  State<SpaceCountdown> createState() => _SpaceCountdownState();
}

class _SpaceCountdownState extends State<SpaceCountdown> {
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      ...
      child: BlocListener<SpacePuzzleBloc, SpacePuzzleState>(
        listener: (context, state) {
          ...
          if (state.status == SpacePuzzleStatus.started) {
        ...
        child: ResponsiveLayoutBuilder(
          ...
          large: (_, __) => BlocBuilder<SpacePuzzleBloc, SpacePuzzleState>(
...
/// {@template space_countdown_seconds_to_begin}
/// Display how many seconds are left to begin the puzzle.
/// {@endtemplate}
@visibleForTesting
class SpaceCountdownSecondsToBegin extends StatefulWidget {
  /// {@macro space_countdown_seconds_to_begin}
  const SpaceCountdownSecondsToBegin({
    Key? key,
  ...
  @override
  State<SpaceCountdownSecondsToBegin> createState() =>
      _SpaceCountdownSecondsToBeginState();
}

class _SpaceCountdownSecondsToBeginState
    extends State<SpaceCountdownSecondsToBegin>
...
/// {@template space_countdown_go}
/// Displays a "Go!" text when the countdown reaches 0 seconds.
/// {@endtemplate}
@visibleForTesting
class SpaceCountdownGo extends StatefulWidget {
  /// {@macro space_countdown_go}
  const SpaceCountdownGo({Key? key}) : super(key: key);

  @override
  State<SpaceCountdownGo> createState() => _SpaceCountdownGoState();
}

class _SpaceCountdownGoState extends State<SpaceCountdownGo>
