...
/// {@template space_puzzle_tile}
/// Displays the puzzle tile associated with [tile]
/// based on the puzzle [state].
/// {@endtemplate}
class SpacePuzzleTile extends StatefulWidget {
  /// {@macro space_puzzle_tile}
  const SpacePuzzleTile({
    Key? key,
    required this.tile,
    required this.state,
  ...
  @override
  State<SpacePuzzleTile> createState() => SpacePuzzleTileState();
}

/// The state of [SpacePuzzleTile].
@visibleForTesting
class SpacePuzzleTileState extends State<SpacePuzzleTile>
  ...
  Widget build(BuildContext context) {
    ...
    final movementDuration = status == SpacePuzzleStatus.loading
      ...
      child: AnimatedAlign(
        ...
        child: ResponsiveLayoutBuilder(
          small: (_, child) => SizedBox.square(
            key: Key('space_puzzle_tile_small_${widget.tile.value}'),
            dimension: _TileSize.small,
            child: child,
          ),
          medium: (_, child) => SizedBox.square(
            key: Key('space_puzzle_tile_medium_${widget.tile.value}'),
            dimension: _TileSize.medium,
            child: child,
          ),
          large: (_, child) => SizedBox.square(
            key: Key('space_puzzle_tile_large_${widget.tile.value}'),
          ...
          child: (_) => MouseRegion(
            ...
            child: ScaleTransition(
              key: Key('space_puzzle_tile_scale_${widget.tile.value}'),
              scale: _scale,
              child: IconButton(
