...
/// {@template space_puzzle_board}
/// Displays the board of the puzzle in a [Stack] filled with [tiles].
/// {@endtemplate}
class SpacePuzzleBoard extends StatefulWidget {
  /// {@macro space_puzzle_board}
  const SpacePuzzleBoard({
    Key? key,
    required this.tiles,
  }) : super(key: key);
  ...
  @override
  State<SpacePuzzleBoard> createState() => _SpacePuzzleBoardState();
}

class _SpacePuzzleBoardState extends State<SpacePuzzleBoard> {
    ...
    return BlocListener<PuzzleBloc, PuzzleState>(
          ...
          _completePuzzleTimer =
            ...
            await showAppDialog<void>(
              ...
              child: MultiBlocProvider(
                providers: [
                  BlocProvider.value(
                    value: context.read<SpaceThemeBloc>(),
                  ),
                  BlocProvider.value(
      ...
      child: ResponsiveLayoutBuilder(
        small: (_, child) => SizedBox.square(
          key: const Key('space_puzzle_board_small'),
          dimension: _BoardSize.small,
          child: child,
        ),
        medium: (_, child) => SizedBox.square(
          key: const Key('space_puzzle_board_medium'),
          dimension: _BoardSize.medium,
          child: child,
        ),
        large: (_, child) => SizedBox.square(
          key: const Key('space_puzzle_board_large'),
