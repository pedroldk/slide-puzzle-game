...
/// {@endtemplate}
class NightSpaceTheme extends SpaceTheme {
  /// {@macro galaxy_space_theme}
  const NightSpaceTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/space/gallery/night.png';

  @override
  String get successThemeAsset => 'assets/images/space/gallery/night.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/space/night';
}
