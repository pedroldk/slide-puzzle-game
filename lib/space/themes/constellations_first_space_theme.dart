...
/// {@endtemplate}
class ConstellationsFirstSpaceTheme extends SpaceTheme {
  /// {@macro galaxy_space_theme}
  const ConstellationsFirstSpaceTheme() : super();
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/space/constellations_first';
}
