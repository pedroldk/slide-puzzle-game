...
/// {@endtemplate}
class MoonSpaceTheme extends SpaceTheme {
  /// {@macro galaxy_space_theme}
  const MoonSpaceTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/space/gallery/moon.png';

  @override
  String get successThemeAsset => 'assets/images/space/gallery/moon.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/space/moon';
}
