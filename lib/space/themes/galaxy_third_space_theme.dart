...
/// {@endtemplate}
class GalaxyThirdSpaceTheme extends SpaceTheme {
  /// {@macro galaxy_space_theme}
  const GalaxyThirdSpaceTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/space/gallery/galaxy_third.png';

  @override
  String get successThemeAsset => 'assets/images/space/gallery/galaxy_third.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/space/galaxy_third';
}
