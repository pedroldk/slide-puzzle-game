...
/// {@template cities_theme}
/// The cities puzzle theme.
/// {@endtemplate}
abstract class CitiesTheme extends PuzzleTheme {
  /// {@macro cities_theme}
  const CitiesTheme() : super();
  ...
  @override
  PuzzleLayoutDelegate get layoutDelegate => const CitiesPuzzleLayoutDelegate();
  ...
  ///
  /// This asset is shown in the Cities theme picker.
  String get themeAsset;

  /// The path to the success image asset of this theme.
  ///
  /// This asset is shown in the success state of the Cities puzzle.
