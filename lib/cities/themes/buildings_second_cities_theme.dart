...
/// {@endtemplate}
class BuildingsSecondCitiesTheme extends CitiesTheme {
  /// {@macro galaxy_cities_theme}
  const BuildingsSecondCitiesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/cities/gallery/buildings_second.png';

  @override
  String get successThemeAsset => 'assets/images/cities/gallery/buildings_second.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/cities/buildings_second';
}
