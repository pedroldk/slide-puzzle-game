...
/// {@endtemplate}
class RiverCitiesTheme extends CitiesTheme {
  /// {@macro galaxy_cities_theme}
  const RiverCitiesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/cities/gallery/river.png';

  @override
  String get successThemeAsset => 'assets/images/cities/gallery/river.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/cities/river';
}
