...
/// {@endtemplate}
class KualaCitiesTheme extends CitiesTheme {
  /// {@macro galaxy_cities_theme}
  const KualaCitiesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/cities/gallery/kuala.png';

  @override
  String get successThemeAsset => 'assets/images/cities/gallery/kuala.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/cities/kuala';
}
