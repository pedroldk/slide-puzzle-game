...
/// {@endtemplate}
class BuildingsFirstCitiesTheme extends CitiesTheme {
  /// {@macro galaxy_cities_theme}
  const BuildingsFirstCitiesTheme() : super();
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/cities/buildings_first';
}
