...
/// {@endtemplate}
class PedestriansCitiesTheme extends CitiesTheme {
  /// {@macro galaxy_cities_theme}
  const PedestriansCitiesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/cities/gallery/pedestrians.png';

  @override
  String get successThemeAsset => 'assets/images/cities/gallery/pedestrians.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/cities/pedestrians';
}
