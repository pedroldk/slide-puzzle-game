...
/// {@endtemplate}
class CityCitiesTheme extends CitiesTheme {
  /// {@macro galaxy_cities_theme}
  const CityCitiesTheme() : super();
  ...
  @override
  String get themeAsset => 'assets/images/cities/gallery/city.png';

  @override
  String get successThemeAsset => 'assets/images/cities/gallery/city.png';
  ...
  @override
  String get dashAssetsDirectory => 'assets/images/cities/city';
}
