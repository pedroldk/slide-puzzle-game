...
import 'package:very_good_slide_puzzle/cities/widgets/cities_timer.dart';
import 'package:very_good_slide_puzzle/theme/themes/themes.dart';
import 'package:very_good_slide_puzzle/theme/widgets/widgets.dart';
import 'package:very_good_slide_puzzle/typography/typography.dart';

/// {@template cities_score}
/// Displays the score of the solved Cities puzzle.
/// {@endtemplate}
class CitiesScore extends StatelessWidget {
  /// {@macro cities_score}
  const CitiesScore({Key? key}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        key: const Key('cities_score_completed'),
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('cities_score_well_done'),
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('cities_score_score'),
                        style: PuzzleTextStyle.headline5.copyWith(
                          color: theme.defaultColor,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('cities_score_number_of_moves'),
