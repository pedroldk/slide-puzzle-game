...
/// The animation builder of [CitiesShareDialog].
class CitiesShareDialogAnimatedBuilder extends StatelessWidget {
  const CitiesShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          CitiesShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  CitiesShareDialogEnterAnimation animation,
);

class CitiesShareDialogEnterAnimation {
  CitiesShareDialogEnterAnimation(this.controller)
