...
import 'package:very_good_slide_puzzle/cities/widgets/cities_share_button.dart';
...
/// {@template cities_share_your_score}
/// Displays buttons to share a score of the completed puzzle.
/// {@endtemplate}
class CitiesShareYourScore extends StatelessWidget {
  /// {@macro cities_share_your_score}
  const CitiesShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final CitiesShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('cities_share_your_score'),
            ...
            SlideTransition(
              ...
              child: Opacity(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      l10n.spaceSuccessShareYourScoreTitle,
                      key: const Key('cities_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      width: messageWidth,
                      child: Text(
                        l10n.spaceSuccessShareYourScoreMessage,
                        key: const Key('cities_share_your_score_message'),
                        textAlign: textAlign,
