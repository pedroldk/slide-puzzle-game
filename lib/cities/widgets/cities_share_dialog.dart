...
import 'package:very_good_slide_puzzle/cities/widgets/cities_score.dart';
import 'package:very_good_slide_puzzle/cities/widgets/cities_share_dialog_animated_builder.dart';
import 'package:very_good_slide_puzzle/cities/widgets/cities_share_your_score.dart';

/// {@template cities_share_dialog}
/// Displays a Cities share dialog with a score of the completed puzzle
/// and an option to share the score using Twitter or Facebook.
/// {@endtemplate}
class CitiesShareDialog extends StatefulWidget {
  /// {@macro cities_share_dialog}
  const CitiesShareDialog({
    Key? key,
  ...
  @override
  State<CitiesShareDialog> createState() => _CitiesShareDialogState();
}

class _CitiesShareDialogState extends State<CitiesShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('cities_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('cities_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('cities_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: CitiesShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('cities_share_dialog_close_button'),
