...
/// {@template cities_countdown}
/// Displays the countdown before the puzzle is started.
/// {@endtemplate}
class CitiesCountdown extends StatefulWidget {
  /// {@macro cities_countdown}
  ...
  @override
  State<CitiesCountdown> createState() => _CitiesCountdownState();
}

class _CitiesCountdownState extends State<CitiesCountdown> {
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      ...
      child: BlocListener<CitiesPuzzleBloc, CitiesPuzzleState>(
        listener: (context, state) {
          ...
          if (state.status == CitiesPuzzleStatus.started) {
...
/// {@template cities_countdown_seconds_to_begin}
/// Display how many seconds are left to begin the puzzle.
/// {@endtemplate}
@visibleForTesting
class CitiesCountdownSecondsToBegin extends StatefulWidget {
  /// {@macro cities_countdown_seconds_to_begin}
  const CitiesCountdownSecondsToBegin({
    Key? key,
  ...
  @override
  State<CitiesCountdownSecondsToBegin> createState() =>
      _CitiesCountdownSecondsToBeginState();
}

class _CitiesCountdownSecondsToBeginState
    extends State<CitiesCountdownSecondsToBegin>
...
/// {@template cities_countdown_go}
/// Displays a "Go!" text when the countdown reaches 0 seconds.
/// {@endtemplate}
@visibleForTesting
class CitiesCountdownGo extends StatefulWidget {
  /// {@macro cities_countdown_go}
  const CitiesCountdownGo({Key? key}) : super(key: key);

  @override
  State<CitiesCountdownGo> createState() => _CitiesCountdownGoState();
}

class _CitiesCountdownGoState extends State<CitiesCountdownGo>
