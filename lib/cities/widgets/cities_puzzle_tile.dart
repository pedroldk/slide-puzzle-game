...
/// {@template cities_puzzle_tile}
/// Displays the puzzle tile associated with [tile]
/// based on the puzzle [state].
/// {@endtemplate}
class CitiesPuzzleTile extends StatefulWidget {
  /// {@macro cities_puzzle_tile}
  const CitiesPuzzleTile({
    Key? key,
    required this.tile,
    required this.state,
  ...
  @override
  State<CitiesPuzzleTile> createState() => CitiesPuzzleTileState();
}

/// The state of [CitiesPuzzleTile].
@visibleForTesting
class CitiesPuzzleTileState extends State<CitiesPuzzleTile>
  ...
  Widget build(BuildContext context) {
    ...
    final movementDuration = status == CitiesPuzzleStatus.loading
      ...
      child: AnimatedAlign(
        ...
        child: ResponsiveLayoutBuilder(
          small: (_, child) => SizedBox.square(
            key: Key('cities_puzzle_tile_small_${widget.tile.value}'),
            dimension: _TileSize.small,
            child: child,
          ),
          medium: (_, child) => SizedBox.square(
            key: Key('cities_puzzle_tile_medium_${widget.tile.value}'),
            dimension: _TileSize.medium,
            child: child,
          ),
          large: (_, child) => SizedBox.square(
            key: Key('cities_puzzle_tile_large_${widget.tile.value}'),
          ...
          child: (_) => MouseRegion(
            ...
            child: ScaleTransition(
              key: Key('cities_puzzle_tile_scale_${widget.tile.value}'),
              scale: _scale,
              child: IconButton(
